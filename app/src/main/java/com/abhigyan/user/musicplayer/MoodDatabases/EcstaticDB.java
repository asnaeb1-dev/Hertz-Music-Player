...
public class EcstaticDB extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "happymood.db";
    ...
    public EcstaticDB(Context context ) {
    ...
    public boolean insertData(String album_ID, String trackName, String path_name, String album_name, String artist_name, String composer, String duration, String size)
    {
